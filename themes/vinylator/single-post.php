        ...
        if (have_posts()) {
            while (have_posts()) {
                ...
                <div class="row d-flex justify-content-center">
                    <img class="d-block col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 post-image" src="http://localhost:8080/wp-content/uploads/2019/06/fond_1.jpg" alt="Premier slide" width="960" height="640">
